...
#import "AMDBNewCase+Create.h"
#import "AMDBManager.h"
#import "AMProtocolManager.h"

@interface AramarkFSP_TestNewCase : XCTestCase

@end

@implementation AramarkFSP_TestNewCase
...
-(AMDBNewCase *)newCaseWithPoSID
{
    ...
    testEntity.fakeID = [NSString stringWithFormat:@"Fake_%.0f", [NSDate timeIntervalSinceReferenceDate]];
...
-(AMDBNewCase *)newCaseWithMEICustomer
{
    ...
    testEntity.mEI_Customer = @"testMEI";
    testEntity.priority = @"High";
    testEntity.subject = @"testSubject";
    testEntity.contactID = @"";
    testEntity.contactEmail = @"";
