...
- (void)setBackgroundimage:(NSString *)imageName {
	UIImageView *imageViewBg = [[UIImageView alloc] initWithImage:[UIImage imageNamed:imageName]];
	imageViewBg.frame = self.bounds;
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event {
	...
	if (delegate && [delegate respondsToSelector:@selector(move:)]) {
		[delegate move:_isMove];
	}
	_isMove = NO;
