...
typedef enum AM_REQUEST_t {
    ...
    AM_REQUEST_GETBTWOLST,
    AM_REQUEST_GETBTACTWOLST,
    AM_REQUEST_SETBTACTTIMER,
    AM_REQUEST_SCRAPBTASSET,
    AM_REQUEST_SETBTWOACTIVE
}AM_REQUEST_Type;
