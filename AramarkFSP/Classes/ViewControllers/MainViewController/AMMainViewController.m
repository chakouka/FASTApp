		...
		switch ([[[notification object] objectForKey:KEY_OF_INFO] intValue]) {
            ...
            case LeftViewButtonType_ActiveAssetInfoBenchTech:
            {
                ...
                if(fullAssetDict)
                {
                    ...
                    self.lblDtlMachineType.text = [[fullAssetDict valueForKeyWithNullToNil:@"Product2"] valueForKeyWithNullToNil:@"Name"];
                    self.lblDtlManufacturerWebsite.text = [[fullAssetDict valueForKeyWithNullToNil:@"Product2"] valueForKeyWithNullToNil:@"Manufacturer_Website__c"];
