...
- (void)awakeFromNib
{
    ...
    [self.btnUpdateDate setTitle:MyLocal(@"UPDATE DATE") forState:UIControlStateNormal];
    [self.btnUpdateDate setTitle:MyLocal(@"UPDATE DATE") forState:UIControlStateHighlighted];
